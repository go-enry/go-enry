...
var LanguagesByExtension = map[string][]string{
	...
	".lvproj":               {"LabVIEW"},
	".ly":                   {"LilyPond"},
	".m":                    {"Limbo", "M", "MATLAB", "MUF", "Mercury", "Objective-C", "Wolfram Language"},
	".m2":                   {"Macaulay2"},
	".m3":                   {"Modula-3"},
	".m3u":                  {"M3U"},
	".m3u8":                 {"M3U"},
...
var ExtensionsByLanguage = map[string][]string{
	...
	"Go":                                 {".go"},
	"Go Template":                        {".gohtml", ".gotmpl", ".html.tmpl", ".tmpl", ".tpl"},
	...
	"GtkRC":                              {".gtkrc"},
	"HAProxy":                            {".cfg"},
	"HCL":                                {".hcl", ".nomad", ".tf", ".tfvars", ".tofu", ".workflow"},
	"HIP":                                {".hip"},
	...
	"IGOR Pro":                           {".ipf"},
	"IL Assembly":                        {".il"},
	"INI":                                {".ini", ".cfg", ".cnf", ".container", ".dof", ".frm", ".lektorproject", ".mount", ".network", ".prefs", ".pro", ".properties", ".service", ".socket", ".target", ".timer", ".url"},
	...
	"JCL":                                {".jcl"},
	"JFlex":                              {".flex", ".jflex"},
	"JSON":                               {".json", ".4dform", ".4dproject", ".avsc", ".geojson", ".gltf", ".har", ".ice", ".json-tmlanguage", ".json.example", ".jsonl", ".mcmeta", ".sarif", ".slnlaunch", ".tact", ".tfstate", ".tfstate.backup", ".topojson", ".webapp", ".webmanifest", ".yy", ".yyp"},
	"JSON with Comments":                 {".jsonc", ".code-snippets", ".code-workspace", ".sublime-build", ".sublime-color-scheme", ".sublime-commands", ".sublime-completions", ".sublime-keymap", ".sublime-macro", ".sublime-menu", ".sublime-mousemap", ".sublime-project", ".sublime-settings", ".sublime-theme", ".sublime-workspace", ".sublime_metrics", ".sublime_session", ".tsconfig.json"},
	"JSON5":                              {".json5"},
	"JSONLD":                             {".jsonld"},
	"JSONiq":                             {".jq"},
	"Jac":                                {".jac"},
	...
	"Protocol Buffer Text Format":        {".textproto", ".pbt", ".pbtxt", ".txtpb"},
	"Public Key":                         {".asc", ".pub"},
	"Pug":                                {".jade", ".pug"},
	"Puppet":                             {".pp"},
	"Pure Data":                          {".pd"},
	...
	"SPARQL":                             {".sparql", ".rq"},
	"SQF":                                {".sqf", ".hqf"},
	"SQL":                                {".sql", ".ddl", ".inc", ".mysql", ".prc", ".tab", ".udf", ".viw"},
	"SQLPL":                              {".sql", ".db2"},
	...
	"Self":                               {".self"},
	"ShaderLab":                          {".shader"},
	"Shell":                              {".sh", ".bash", ".bats", ".cgi", ".command", ".fcgi", ".ksh", ".sbatch", ".sh.in", ".slurm", ".tmux", ".tool", ".trigger", ".zsh", ".zsh-theme"},
	...
	"Witcher Script":                     {".ws"},
	"Wolfram Language":                   {".mathematica", ".cdf", ".m", ".ma", ".mt", ".nb", ".nbp", ".wl", ".wls", ".wlt"},
	"Wollok":                             {".wlk"},
