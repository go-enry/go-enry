...
var ContentHeuristics = map[string]*Heuristics{
	...
	".action": &Heuristics{
		rule.And(
			...
			rule.Or(
				rule.MatchingLanguages(""),
				regex.MustCompileMultiline(`(?i)^[a-z]\w*(?:\/[a-z]\w*)?(?:<=\d+)?(?:\[(?:<=\d+)?\])?\s+\w+\b`),
			),
			rule.Or(
				rule.MatchingLanguages(""),
	...
	".alg": &Heuristics{
		rule.Or(
			rule.MatchingLanguages("ALGOL"),
			regex.MustCompileMultiline(`(?i)^comment\b.*(;|comment)|^#[^#\r\n]+#$|(?i)\b(integer|real|boolean|string)\b\s+\w+\s*:=\s*|(?i)^begin[\s\S]*^end`),
		),
	},
	".app": &Heuristics{
		rule.Or(
	...
	".cls": &Heuristics{
		...
		rule.Or(
			...
			regex.MustCompileMultiline(`(?i)^\s*(?:end\s+(?:class|interface)\.|(?:class|interface)\s+[a-z_][a-z0-9_#$%&-]*:)`),
		),
	},
	".cmp": &Heuristics{
		rule.Or(
	...
	".container": &Heuristics{
		rule.And(
			...
			rule.Or(
				rule.MatchingLanguages(""),
				regex.MustCompileMultiline(`^[#\s]*\[[^\]]+\]\s*$`),
			),
			rule.Or(
				rule.MatchingLanguages(""),
				regex.MustCompileMultiline(`^[^#!;][^=]*=`),
	...
	".k": &Heuristics{
		rule.Or(
			rule.MatchingLanguages("KCL"),
			regex.MustCompileMultiline(`^schema [A-Za-z0-9_-]+|^\}$|\s*\}\s*`),
		),
		rule.Or(
			rule.MatchingLanguages("KFramework"),
			regex.MustCompileMultiline(`^requires\s+"[^"]+"$|^syntax\s+\w+\s+::=.*|^endmodule$`),
		),
	},
	".l": &Heuristics{
		rule.Or(
	...
	".lp": &Heuristics{
		rule.Or(
			rule.MatchingLanguages("Lambdapi"),
			regex.MustCompileMultiline(`(?:^|\s)symbol(?:$|\s)|(?:^|\s)rule(?:$|\s)`),
		),
		rule.Or(
			rule.MatchingLanguages("Linear Programming"),
			regex.MustCompileMultiline(`(?i)^\s*(?:minimize|minimum|min|maximize|maximum|max)(?:\s+multi-objectives)?\s*$`),
		),
		rule.Or(
			rule.MatchingLanguages("Answer Set Programming"),
			regex.MustCompileMultiline(`^\s*#(?:include|const|program|script|show|minimize|maximize|heuristic|project|edge|theory|defined)\b|^\s*(?:[A-Za-z_]\w*(?:\([^)]*\))?\s*:-|:-)\s[^.]*\.|^\s*[a-z_][a-zA-Z0-9_]*(?:\([^)]*\))?\s*\.\s*$`),
		),
	},
	".ls": &Heuristics{
		rule.Or(
	...
	".m": &Heuristics{
		...
		rule.And(
			rule.MatchingLanguages("Wolfram Language"),
			rule.Or(
				rule.MatchingLanguages(""),
				regex.MustCompileMultiline(`\(\*`),
			),
	...
	".mps": &Heuristics{
		rule.Or(
			rule.MatchingLanguages("JetBrains MPS"),
			regex.MustCompileMultiline(`<persistence`),
		),
		rule.Or(
			rule.MatchingLanguages("Mathematical Programming System"),
			regex.MustCompileMultiline(`(?i)^\s*(ROWS|COLUMNS)\s*$`),
		),
	},
	".ms": &Heuristics{
		rule.Or(
	...
	".p": &Heuristics{
		...
		rule.Or(
			rule.MatchingLanguages("OpenEdge ABL"),
			regex.MustCompileMultiline(`(?i)\bDEFINE\s+(?:VARIABLE|TEMP-TABLE|BUFFER|QUERY|INPUT\s+PARAMETER|OUTPUT\s+PARAMETER)\b|(?i)\bEND(?:\s+(?:PROCEDURE|FUNCTION|DO|FOR\s+EACH))?\.`),
		),
	},
	".pc": &Heuristics{
		rule.Or(
			rule.MatchingLanguages("Pro*C"),
			regex.MustCompileMultiline(`^\s*EXEC\s+SQL\s`),
		),
		rule.And(
			rule.MatchingLanguages("pkg-config"),
			rule.Or(
				rule.MatchingLanguages(""),
				regex.MustCompileMultiline(`^Name:[ \t]+\S`),
			),
			rule.Or(
				rule.MatchingLanguages(""),
				regex.MustCompileMultiline(`^Description:[ \t]+\S`),
			),
			rule.Or(
				rule.MatchingLanguages(""),
				regex.MustCompileMultiline(`^Version:[ \t]+\S`),
			),
		),
	},
	".php": &Heuristics{
	...
	".tl": &Heuristics{
		rule.And(
			...
			rule.Or(
				rule.MatchingLanguages(""),
				regex.MustCompileMultiline(`\b(local|function|end|record|interface|enum)\b`),
			),
		),
		rule.Always(
			rule.MatchingLanguages("Type Language"),
		),
	},
	".tlv": &Heuristics{
		rule.Or(
	...
	".tpl": &Heuristics{
		rule.Or(
			rule.MatchingLanguages("Go Template"),
			regex.MustCompileMultiline(`\{\{-?\s*(\`+"`"+`?\"\\?\"?|\/\*\s|\w*)\b`),
		),
		rule.Or(
			rule.MatchingLanguages("Smarty"),
			regex.MustCompileRuby(`(?<!\{)\{(\*\s|\$|\/)?\w*\b`),
		),
	},
	".ts": &Heuristics{
		rule.Or(
...
\]`),
	...
	".v": &Heuristics{
		...
		rule.Or(
			...
			regex.MustCompileMultiline(`^[ \t]*module\s+[^\s()]+\s*\#?\(|^[ \t]*`+"`"+`(?:define|ifdef|ifndef|include|timescale|pragma)|^[ \t]*always[ \t]*@|^[ \t]*initial[ \t]*(begin|@)`),
		),
		rule.Or(
